...
<body>
  ...
  <div class="container">
   ...
   <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mx-auto">
     ...
     <li class="nav-item">
      <a href="#" class="nav-link"><i class="fas fa-shopping-cart fa-2x"></i>
      </a>
     </li>
    </ul>
    ...
    <form class="form-inline">
     <input class="form-control mr-sm-2 justify-content-end" type="search" placeholder="Search" aria-label="search" />
 ...
 <div class="container">
  <div class="col-md-3">
   <div class="panel panel-warning sidebar-menu">
    <div class="panel-heading bg-light">
     <h3 class="panel-title">Products Categories</h3>
    </div>

    <!-----Starts Of The Body-------->
    <div class="panel-body d-print-block">
